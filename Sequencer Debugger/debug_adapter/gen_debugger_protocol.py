...
https://code.visualstudio.com/api/extension-guides/debugger-extension has a brief overview.

Run this module to regenerate the `schema.py` file.
...
'''
    ...
    contents.append('from .base_schema import BaseSchema, register, register_request, register_response, register_event')
    contents.append('')
    for class_to_generate in classes_to_generate.values():
        contents.append(class_template % class_to_generate)

    parent_dir = os.path.dirname(__file__)
    schema = os.path.join(parent_dir, 'schema.py')
